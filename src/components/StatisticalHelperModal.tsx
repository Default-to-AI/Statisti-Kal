...
export default function StatisticalHelperModal({ isOpen, onClose, initialTab ='sigma-vs-s' }: StatisticalHelperModalProps) {
 ...
 className="relative w-full max-w-4xl rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
 >
 {/* Header */}
 <div className="p-4 sm:p-5 border-b border-slate-800 bg-gradient-to-r from-indigo-50/50 to-blue-50/20 from-slate-800/60 to-slate-900 flex items-center justify-between">
 <div className="flex items-center gap-2.5">
 <div className="p-2.5 rounded-xl bg-indigo-600/10 text-indigo-400">
 <Sparkles className="w-5 h-5 animate-pulse" />
 </div>
 <div>
 <h3 className="font-extrabold text-sm sm:text-base text-slate-100 font-sans">
 ...
 <button 
 onClick={onClose}
 className="p-1.5 rounded-lg border border-slate-800 hover:bg-slate-800 text-slate-400 [&_svg]:w-5 [&_svg]:h-5 transition-all"
 aria-label="סגור"
 >
 <X />
 </button>
 ...
 {/* Intro Banner */}
 <div className="p-4 rounded-xl bg-orange-50/15 bg-orange-950/5 border border-orange-200/50 border-orange-900/40 flex items-start gap-3">
 <div className="p-2 rounded-lg bg-orange-100 bg-orange-900/20 text-orange-600 text-orange-400 mt-0.5">
 <Info className="w-4 h-4" />
 </div>
 <div className="flex-1 space-y-1">
 <h4 className="font-extrabold text-sm text-orange-850 text-orange-300">
 ...
 {/* Population Side */}
 <div className="p-4 rounded-xl border border-blue-100 border-blue-900/40 bg-blue-50/10 bg-blue-950/5 hover:border-blue-300 hover:border-blue-800 transition-all shadow-sm">
 <div className="flex items-center justify-between mb-3">
 <span className="px-2.5 py-0.5 rounded-full bg-blue-100 bg-blue-900/30 text-blue-300 text-[10px] sm:text-xs font-black">
 אוכלוסייה (עולם תיאורטי)
 </span>
 <span className="text-xl font-bold text-blue-400 font-mono"><InlineMath math="\sigma" /> (Sigma)</span>
 </div>
 
 <h5 className="font-black text-xs sm:text-sm text-slate-100 mb-1.5">
 ...
 <div className="bg-slate-950 p-2.5 rounded-lg border border-blue-200 border-slate-800 text-center">
 ...
 {/* Sample Side */}
 <div className="p-4 rounded-xl border border-emerald-900/40 bg-emerald-950/5 hover:border-emerald-800 transition-all shadow-sm">
 <div className="flex items-center justify-between mb-3">
 <span className="px-2.5 py-0.5 rounded-full bg-emerald-900/30 text-emerald-300 text-[10px] sm:text-xs font-black">
 מדגם (עולם מעשי - הנתונים שיש לנו)
 </span>
 <span className="text-xl font-bold text-emerald-400 font-mono"><InlineMath math="S" /> (Capital S)</span>
 </div>
 ...
 <div className="bg-slate-950 p-2.5 rounded-lg border border-emerald-200 border-slate-800 text-center">
 ...
 <div className="p-4 rounded-xl bg-indigo-50/10 bg-slate-800/40 border border-slate-700">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 font-sans">
 למה מחלקים ב-<InlineMath math="n-1" /> במדגם ולא ב-<InlineMath math="n" />? (תיקון בסל - Bessel's Correction)
 </h4>
 <div className="text-xs space-y-2.5 text-slate-350 leading-relaxed">
 <p>
 ...
 <div className="p-4.5 rounded-xl bg-indigo-600/5 bg-indigo-950/10 border border-indigo-100 border-indigo-900/30">
 <h4 className="font-extrabold text-sm text-indigo-400 mb-1.5 font-sans">
 איך "שגיאת התקן" נולדת מתמטית ואיך השורש יורד למטה?
 </h4>
 <p className="text-xs text-slate-650 text-slate-300 leading-relaxed">
 ...
 {/* Step 1 */}
 <div className="p-3.5 bg-slate-950/50 rounded-xl border border-slate-800/80 flex gap-3.5">
 ...
 <div className="flex-1 space-y-1">
 <h5 className="font-extrabold text-xs sm:text-sm text-slate-150">
 ...
 <div className="bg-slate-900 p-2.5 rounded border border-slate-800 text-center font-mono">
 ...
 <div className="bg-slate-900 p-2.5 rounded border border-slate-800 text-center font-mono text-base font-black text-indigo-400 flex items-center justify-center gap-2">
 <span><InlineMath math="SE = \sqrt{Var(\overline{X})} = \sqrt{\frac{\sigma^2}{n}} = \frac{\sigma}{\sqrt{n}}" /></span>
 </div>
 <p className="text-[11px] text-emerald-400 leading-relaxed font-black mt-2">
 ...
 {/* Input Sliders */}
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl border border-slate-800 bg-slate-900 shadow-sm">
 ...
 <span className="font-mono bg-indigo-50 bg-slate-800 text-indigo-400 px-2 py-0.5 rounded font-black text-xs">
 {popSigma}
 </span>
 </div>
 <input 
 ...
 className="w-full cursor-pointer h-1.5 bg-slate-200 bg-slate-700 rounded-lg appearance-none accent-indigo-600"
 />
 ...
 <div className="p-3 bg-gradient-to-r from-indigo-600/5 to-blue-600/5 from-slate-8 bg-slate-950/40 rounded-xl border border-dashed border-slate-800 text-center grid grid-cols-1 md:grid-cols-3 gap-3 items-center">
 ...
 <div className="space-y-1 border-y md:border-y-0 md:border-x border-slate-800 py-2 md:py-0">
 ...
 <span className="font-mono text-base font-black text-emerald-400 block bg-emerald-50 bg-emerald-950/20 px-3 py-1 rounded inline-block">
 ...
 <label className="flex items-center gap-1.5 font-bold text-indigo-400">
 ...
 {/* SVG Graph rendering */}
 <div className="relative h-[200px] bg-slate-900 rounded-lg border border-slate-800 flex items-center justify-center overflow-hidden">
