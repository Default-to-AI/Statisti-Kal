...
interface FormulaSheetProps {
  // Dark-only theme - no props needed
}
...
export default function FormulaSheet() {
 ...
 <ul className="list-disc leading-relaxed pr-6 text-xs sm:text-sm space-y-1 text-slate-400">
 ...
 <div className="p-3 bg-slate-900/40 rounded-xl text-center">
 ...
 <div className="p-3 bg-slate-900/40 rounded-xl overflow-x-auto text-center">
 ...
 <div className="p-4 rounded-xl border border-rose-900/40 bg-rose-950/5">
 <h4 className="font-extrabold text-sm text-rose-400 mb-2 border-r-2 border-rose-500 pr-2 text-right" dir="rtl">מאורעות זרים (Mutually Exclusive)</h4>
 ...
 <div className="bg-slate-800/80 p-2.5 rounded-lg border border-slate-700/50 text-center text-xs font-mono font-black text-rose-600 text-rose-400">
 <InlineMath math="A \cap B = \emptyset \implies P(A \cap B) = 0" />
 </div>
 </div>
 <div className="p-4 rounded-xl border border-emerald-900/40 bg-emerald-950/5">
 <h4 className="font-extrabold text-sm text-emerald-400 mb-2 border-r-2 border-emerald-500 pr-2 text-right" dir="rtl">מאורעות בלתי תלויים (Independent)</h4>
 <p className="text-xs sm:text-sm text-slate-400 leading-relaxed mb-3">
 התרחשותו או אי-התרחשותו של אחד אינה משפיעה על סיכויי ההתרחשות של האחר.
 </p>
 <div className="bg-slate-800/80 p-2.5 rounded-lg border border-slate-700/50 text-center text-xs font-mono font-black text-emerald-400">
 ...
 <ul className="list-disc leading-relaxed pr-6 text-xs sm:text-sm space-y-2 text-slate-400">
 <li>
 ...
 <div className="mt-2.5 p-3.5 bg-indigo-950/5 rounded-xl border border-slate-800">
 <span className="text-xs font-black text-indigo-400 block mb-1.5">קומבינטוריקה שימושית (<InlineMath math="n" /> פריטים לבחור <InlineMath math="k" />):</span>
 ...
 <div className="p-3.5 bg-slate-800/80 rounded-xl border border-slate-700/50 text-center shadow-inner">
 ...
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 border-r-2 border-blue-500 pr-2 text-right" dir="rtl">1. משפט המכפלה (Product Rule)</h4>
 <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
 הצלבת הסתברויות עבור תת-מאורעות:
 </p>
 <div className="p-2 bg-slate-800/80 rounded-lg text-center font-mono">
 <InlineMath math="P(A \cap B) = P(B) \cdot P(A \mid B) = P(A) \cdot P(B \mid A)" />
 </div>
 </div>

 <div className="space-y-1">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 border-r-2 border-blue-500 pr-2 text-right" dir="rtl">2. חוק ההסתברות השלמה (Total Probability)</h4>
 <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
 ...
 <div className="space-y-1">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 border-r-2 border-blue-500 pr-2 text-right" dir="rtl">3. חוק בייס (Bayes' Theorem)</h4>
 <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
 הסתברות אפוסטריורית (עדכון הסתברות גורם):
 </p>
 <div className="p-3 bg-slate-800/80 rounded-lg text-center font-mono">
 ...
 <div className="p-2.5 bg-slate-900/45 rounded-xl font-mono text-xs">
 ...
 <div className="p-3.5 bg-slate-900/40 rounded-xl text-center">
 ...
 <ul className="list-disc pr-6 text-xs sm:text-sm space-y-1.5 text-slate-400 font-sans">
 ...
 <div className="p-3 bg-slate-900/40 rounded-xl text-center font-sans">
 <BlockMath math="Var(X) = \sigma^2 = \mathbb{E}\left[(X - \mu)^2\right] = \mathbb{E}[X^2] - (\mathbb{E}[X])^2" />
 </div>
 
 <div className="p-3.5 bg-indigo-950/15 rounded-xl border border-indigo-900/30 flex flex-col sm:flex-row items-center justify-between gap-2.5">
 <div className="text-right flex-1">
 <span className="block text-xs font-black text-slate-200">S מול סמל סיגמא (<InlineMath math="\sigma" />): הבולבלת נגמרה עכשיו!</span>
 ...
 <ul className="list-disc pr-6 text-xs sm:text-sm space-y-1.5 text-slate-400">
 ...
 <p className="text-xs text-rose-400 font-bold border-l-2 border-rose-500 pr-2 font-sans">
 ...
 <div className="p-3.5 bg-slate-900/40 rounded-xl text-center space-y-2">
 <div><InlineMath math="f(x) \ge 0 \quad \text{for all } x" /></div>
 <div className="pt-2 border-t border-slate-800"><InlineMath math="\int_{-\infty}^{\infty} f(x) dx = 1" /></div>
 </div>
 ...
 <ul className="list-disc pr-6 text-xs sm:text-sm space-y-1 text-slate-300">
 ...
 icon: <Sigma className="w-5 h-5 text-indigo-400" />,
 subsections: [
 {
 ...
 <div className="space-y-4">
 {/* Discrete Uniform */}
 <div className="p-4 rounded-xl border border-slate-700/60 bg-slate-800/80 shadow-sm animate-fade-in">
 <h4 className="font-extrabold text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">1. התפלגות אחידה בדידה (Discrete Uniform)</h4>
 ...
 <span className="block text-slate-400 text-[10px] mb-1">פונקציית הסתברות</span>
 <InlineMath math="P(X = k) = \frac{1}{b - a + 1}" />
 </div>
 <div className="p-2 bg-slate-900 rounded-lg">
 <span className="block text-slate-400 text-[10px] mb-1">תוחלת</span>
 <InlineMath math="\mathbb{E}[X] = \frac{a + b}{2}" />
 </div>
 <div className="p-2 bg-slate-900 rounded-lg">
 <span className="block text-slate-400 text-[10px] mb-1">שונות (שלמים)</span>
 ...
 {/* Binomial */}
 <div className="p-4 rounded-xl border border-slate-700/60 bg-slate-800/80 shadow-sm animate-fade-in">
 <h4 className="font-extrabold text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">2. התפלגות בינומית <InlineMath math="(X \sim Bin(n, p))" /></h4>
 <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-3">
 ...
 <div className="p-2 bg-slate-900 rounded-lg text-[11px] overflow-x-auto select-all">
 <span className="block text-slate-400 text-[10px] mb-1">פונקציית הסתברות</span>
 ...
 <div className="p-2 bg-slate-900 rounded-lg">
 <span className="block text-slate-400 text-[10px] mb-1">שונות</span>
 ...
 {/* Continuous Uniform */}
 <div className="p-4 rounded-xl border border-slate-700/60 bg-slate-800/80 shadow-sm animate-fade-in">
 <h4 className="font-extrabold text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">1. התפלגות אחידה רציפה <InlineMath math="(X \sim U(a, b))" /></h4>
 <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-3">
 כאשר המשתנה מרוח בצפיפות קבועה ואחידה מעל קטע יחיד ומוגדר <InlineMath math="[a, b]" />.
 </p>
 <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 text-center text-xs">
 <div className="p-2 bg-slate-900 rounded-lg">
 <span className="block text-slate-400 text-[10px] mb-1">צפיפות <InlineMath math="f(x)" /> בתוך</span>
 <InlineMath math="\frac{1}{b - a}" />
 </div>
 <div className="p-2 bg-slate-900 rounded-lg">
 <span className="block text-slate-400 text-[10px] mb-1">מצטברת <InlineMath math="F(x)" /></span>
 ...
 {/* Normal Distribution */}
 <div className="p-4 rounded-xl border border-slate-700/60 bg-slate-800/80 shadow-sm animate-fade-in">
 <h4 className="font-extrabold text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">2. התפלגות נורמלית <InlineMath math="(X \sim N(\mu, \sigma^2))" /></h4>
 <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-3">
 ההתפלגות המרכזית במחקר. סימטרית לחלוטין סביב התוחלת (צורת פעמון גאוס).
 </p>
 <div className="space-y-4 text-xs sm:text-sm">
 <div className="p-3 bg-slate-900 rounded-lg flex flex-col md:flex-row items-center justify-between gap-2.5">
 <div>
 <strong className="block text-slate-100">נוסחת התקנון (Standardization):</strong>
 <span className="text-slate-450 text-xs">מעבר ממשתנה מקרי כללי למשתנה נורמלי סטנדרטי <InlineMath math="Z" />:</span>
 </div>
 <div className="text-lg font-mono font-black text-blue-400 bg-slate-800/90 px-3 py-1 rounded-md border border-slate-700/50">
 <InlineMath math="Z = \frac{X - \mu}{\sigma} \sim N(0, 1)" />
 </div>
 </div>

 <div className="p-3 bg-slate-900 rounded-lg">
 <strong className="block text-slate-100 mb-2">תכונות ההתפלגות הסטנדרטית ושימוש בטבלת <InlineMath math="Z" />:</strong>
 <ul className="list-disc pr-5 text-xs space-y-1.5 text-slate-300">
 ...
 <div className="p-3 bg-slate-900 rounded-lg">
 <strong className="block text-slate-100 mb-1.5">קומבינציות לינאריות של משתנים עצמאיים:</strong>
 <span className="text-slate-450 text-xs leading-relaxed block mb-2">
 ...
 <div className="text-center font-mono py-1 rounded-md bg-slate-800/90 border border-slate-700/50 overflow-x-auto">
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="p-4 bg-slate-800/65 rounded-xl border border-slate-700/60 shadow-sm">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">עבור ממוצע המדגם <InlineMath math="(\overline{X})" /></h4>
 ...
 <div className="p-4 bg-slate-800/65 rounded-xl border border-slate-700/60 shadow-sm">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 border-r-2 border-indigo-500 pr-2 text-right" dir="rtl">עבור סכום המדגם <InlineMath math="(S_n = \sum X_i)" /></h4>
 <p className="text-xs text-slate-350 leading-relaxed mb-3">
 ...
 <div className="space-y-1 bg-slate-900 px-3 py-2.5 rounded-xl text-xs sm:text-sm leading-relaxed text-slate-300">
 <strong className="block text-slate-100 mb-1.5">הבנת כיוון הקשר:</strong>
 ...
 <div className="p-3.5 bg-slate-900/45 rounded-xl">
 ...
 <div className="p-4 bg-indigo-950/5 border border-slate-800 rounded-xl">
 <span className="block text-[10px] text-slate-400 font-black mb-1 flex justify-center">עבור סכום תלוי:</span>
 <InlineMath math="Var(X + Y) = Var(X) + Var(Y) + 2Cov(X, Y)" />
 </div>
 <div className="p-4 bg-indigo-950/5 border border-slate-800 rounded-xl">
 <span className="block text-[10px] text-slate-400 font-black mb-1 flex justify-center">עבור הפרש תלוי:</span>
 <InlineMath math="Var(X - Y) = Var(X) + Var(Y) - 2Cov(X, Y)" />
 </div>
 </div>
 ...
 <div className="p-3.5 bg-slate-900 text-xs sm:text-sm rounded-xl space-y-1">
 <strong className="block text-slate-100 mb-1 leading-normal">טווח ומשמעות המתאם מול האוכלוסייה:</strong>
 <ul className="list-disc pr-5 text-xs text-slate-300 space-y-1">
 ...
 <div className="bg-slate-900 p-2 rounded border border-slate-800 text-center font-mono text-xs">
 ...
 <div className="bg-slate-900 p-2 rounded border border-slate-800 text-center text-xs">
 ...
 content: (
 <div className="space-y-4">
 <div className="p-3.5 bg-slate-900 text-xs sm:text-sm rounded-xl leading-relaxed">
 <strong>אחוזונים ורבעונים:</strong> מחלקים את הנתונים הממוינים למאה/ארבעה חלקים שווים.
 <ul className="list-disc pr-5 mt-2 text-xs text-slate-300 space-y-1">
 ...
 <div className="p-3.5 rounded-xl border border-indigo-200/50 border-slate-800 bg-slate-900">
 <h5 className="font-extrabold text-slate-100 mb-2">התפלגות סימטרית</h5>
 <p className="text-slate-500 mb-2 text-[11px]">הפעמון מאוזן לחלוטין סביב המרכז:</p>
 <span className="font-bold text-indigo-400 font-mono">ממוצע ≈ חציון ≈ שכיח</span>
 </div>

 <div className="p-3.5 rounded-xl border border-indigo-200/50 border-slate-800 bg-slate-900">
 <h5 className="font-extrabold text-slate-100 mb-2">אסימטריה חיובית (ימנית)</h5>
 <p className="text-slate-500 mb-2 text-[11px]">זנב שרוע לצד ימין, קיצוני חלש בכיוון החיובי:</p>
 <span className="font-bold text-amber-400 font-mono">ממוצע &gt; חציון &gt; שכיח</span>
 </div>

 <div className="p-3.5 rounded-xl border border-indigo-200/50 border-slate-800 bg-slate-900">
 <h5 className="font-extrabold text-slate-100 mb-2">אסימטריה שלילית (שמאלית)</h5>
 <p className="text-slate-500 mb-2 text-[11px]">זנב שרוע לצד שמאל, משיכה בכיוון השלילי:</p>
 <span className="font-bold text-rose-600 text-rose-400 font-mono">ממוצע &lt; חציון &lt; שכיח</span>
 </div>
 </div>
 </div>
 )
 ...
 content: (
 <div className="space-y-4">
 <div className="p-3.5 bg-slate-900/50 rounded-xl text-xs sm:text-sm leading-relaxed text-slate-300">
 <strong>1. אומד חסר הטיה (Unbiased Estimator):</strong>
 <br />
 אומד שהתוחלת התיאורטית שלו שווה לפרמטר האמיתי באוכלוסייה:
 <div className="my-2 p-1.5 bg-slate-950 rounded text-center font-mono font-black text-xs text-indigo-400">
 ...
 <div className="p-3.5 bg-emerald-50/40 bg-emerald-950/15 rounded-xl border border-emerald-100/70 border-emerald-900/30 flex flex-col sm:flex-row items-center justify-between gap-2.5">
 <div className="text-right flex-1">
 <span className="block text-xs font-black text-emerald-300">למה מחלקים בשורש של n? (איך השורש הגיע למכנה?)</span>
 <p className="text-[10px] sm:text-xs text-slate-400 leading-relaxed mt-0.5">
 ...
 <div className="p-2.5 bg-slate-950 text-center font-mono rounded">
 ...
 <h5 className="font-extrabold text-[12px] text-indigo-400 mb-2">מבחן דו-צדדי (Two-Tailed)</h5>
 <div className="text-xs space-y-1 bg-slate-950 p-2.5 rounded font-mono">
 ...
 <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-center">
 <h5 className="font-extrabold text-[12px] text-indigo-400 mb-2">מבחן חד-צדדי ימני</h5>
 <div className="text-xs space-y-1 bg-slate-950 p-2.5 rounded font-mono">
 <div><InlineMath math="H_0: \theta \le \theta_0" /></div>
 <div className="text-indigo-400 font-extrabold"><InlineMath math="H_1: \theta > \theta_0" /></div>
 </div>
 </div>

 <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-center">
 <h5 className="font-extrabold text-[12px] text-indigo-400 mb-2">מבחן חד-צדדי שמאלי</h5>
 <div className="text-xs space-y-1 bg-slate-950 p-2.5 rounded font-mono">
 ...
 <div className="p-4 rounded-xl border border-red-100 bg-red-50/10 border-red-900/40 bg-rose-950/5">
 <strong className="text-red-400 block mb-1">טעות מסוג ראשון (<InlineMath math="\alpha" />):</strong>
 דחייה מוטעית של השערת האפס כשהיא נכונה.
 <div className="mt-2 text-center p-1 bg-slate-950 font-mono rounded text-xs">
 <InlineMath math="\alpha = P(\text{Reject } H_0 \mid H_0 \text{ is true})" />
 </div>
 </div>

 <div className="p-4 rounded-xl border border-amber-100 bg-amber-50/10 border-amber-900/40 bg-amber-950/5">
 <strong className="text-amber-400 block mb-1">טעות מסוג שני <InlineMath math="(\beta)" />:</strong>
 אי-דחיית השערה שקרית כשהאלטרנטיבית נכונה.
 <div className="mt-2 text-center p-1 bg-slate-950 font-mono rounded text-xs font-bold">
 ...
 <strong className="block text-slate-100">מגוון הסטטיסטיים השכיחים:</strong>
 <ul className="list-disc pr-5 leading-relaxed text-slate-300 space-y-1.5">
 ...
 <div className="p-4 bg-slate-900/50 rounded-xl space-y-3 text-xs sm:text-sm">
 <div>
 <strong className="block text-indigo-400">1. שיטת ערך קריטי (Critical Value):</strong>
 נחפש בטבלאות ערך קריטי בהתאם ל-<InlineMath math="\alpha" /> ודרגות החופש.
 <ul className="list-disc pr-5 mt-1 text-xs text-slate-400 space-y-1">
 ...
 <strong className="block text-emerald-400">2. גישת ה-P-Value (הכלל האוניברסלי):</strong>
 ההסתברות לקבל תוצאה קיצונית לפחות כמו שנמדדה, תחת הנחה ש-<InlineMath math="H_0" /> נכונה.
 <div className="my-2 p-1.5 bg-slate-950 font-black font-mono text-center rounded text-emerald-600">
 ...
 <div className="p-4 bg-slate-900/50 rounded-xl border border-slate-800 font-semibold text-slate-300">
 ...
 <div className="p-4 rounded-2xl border flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm transition-all bg-slate-900 border-slate-800">
 ...
 className="w-full pl-4 pr-10 py-1.5 text-xs sm:text-sm bg-slate-950 border border-slate-800 rounded-xl outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-semibold"
 />
 </div>
 ...
 className="flex items-center gap-1.5 py-1.5 px-3 rounded-lg border border-slate-800 bg-slate-950 text-[11px] font-black text-slate-300 hover:bg-slate-100 hover:bg-slate-900 transition-all shadow-sm"
 >
 <Maximize2 size={12} />
 הרחב הכל
 </button>
 ...
 <div className="p-5 rounded-2xl border shadow-sm transition-all bg-slate-900 border-slate-800">
 <h3 className="text-xs font-black text-slate-400 uppercase mb-4 tracking-wider flex items-center gap-2 border-b border-slate-800 pb-2">
 ...
 :'text-slate-400 hover:bg-slate-800/50 hover:text-slate-900 hover:text-slate-200'
 }`}
 >
 ...
 id={section.id}
 className="rounded-2xl border p-5 md:p-6 transition-all scroll-mt-24 shadow-sm bg-slate-900 border-slate-800"
 >
 {/* Section Header */}
 ...
 isExpanded
 ? ('bg-slate-950/40 border-slate-800/80 ring-2 ring-blue-500/5')
 ...
 isExpanded ?'text-blue-400' :'text-slate-200'
 }`}
 >
 <span className="text-slate-800 text-white">{sub.title}</span>
 ...
 >
 <div className="p-4 pt-1 border-t border-slate-800/70 text-slate-300">
 {sub.content}
 </div>
 </motion.div>
 )}
 ...
 {section.id ==='c6' && (
 <div className="mt-6 p-4 rounded-xl border border-dashed border-indigo-900/55 bg-indigo-950/5">
 <h4 className="font-extrabold text-xs sm:text-sm text-indigo-400 mb-2 flex items-center gap-2">
 <Sliders size={14} />
 ...
 className="w-full px-3 py-1.5 text-xs bg-slate-950 border border-slate-800 rounded-lg outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all font-mono font-bold"
 />
 </div>
 ...
 <span className="font-mono font-black text-xs text-slate-100">{computedStats.mean}</span>
 </div>
 <div className="p-2 bg-slate-950 rounded border border-slate-800">
 <span className="block text-[9px] text-slate-400 font-bold">חציון (Q₂)</span>
 <span className="font-mono font-black text-xs text-slate-100">{computedStats.median}</span>
 </div>
 <div className="p-2 bg-slate-950 rounded border border-slate-800">
 <span className="block text-[9px] text-slate-400 font-bold">טווח בין-רבעוני (IQR)</span>
 <span className="font-mono font-black text-xs text-indigo-400">{computedStats.iqr}</span>
 </div>
 <div className="p-2 bg-slate-950 rounded border border-slate-800">
 <span className="block text-[9px] text-slate-400 font-bold">שונות המדגם (S²)</span>
 <span className="font-mono font-black text-xs text-emerald-400">{computedStats.sampleVar}</span>
 </div>
 </div>
 )}
 </div>
